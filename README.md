...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ee-15.10.svg)](https://hub.docker.com/r/alvistack/gitlab-ee-15.10)
...
-   [`alvistack/gitlab-ee-15.9`](https://hub.docker.com/r/alvistack/gitlab-ee-15.9)
    -   [`packer/docker-15.9/packer.json`](https://github.com/alvistack/docker-gitlab-ee/blob/master/packer/docker-15.9/packer.json)
...
Start GitLab EE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ee-15.10
