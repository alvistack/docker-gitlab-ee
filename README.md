...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ee-15.7.svg)](https://hub.docker.com/r/alvistack/gitlab-ee-15.7)
...
-   [`alvistack/gitlab-ee-15.6`](https://hub.docker.com/r/alvistack/gitlab-ee-15.6)
    -   [`packer/docker-15.6/packer.json`](https://github.com/alvistack/docker-gitlab-ee/blob/master/packer/docker-15.6/packer.json)
...
Start GitLab EE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ee-15.7
