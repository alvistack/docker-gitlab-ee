...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ee-15.11.svg)](https://hub.docker.com/r/alvistack/gitlab-ee-15.11)
...
Start GitLab EE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ee-15.11
