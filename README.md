...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-ee-15.6.svg)](https://hub.docker.com/r/alvistack/gitlab-ee-15.6)
...
Start GitLab EE Server:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-ee-15.6
